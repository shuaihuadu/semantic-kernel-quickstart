...
public class TextChunkingAndEmbedding : BaseTest
{
    private const string EmbeddingModelName = "text-embedding-ada-002";
    private static readonly Tokenizer tokenizer = Tokenizer.CreateTiktokenForModel(EmbeddingModelName);
    ...
    private async Task RunExampleAsync()
    {
        ...
        List<string> lines = TextChunker.SplitPlainTextLines(ChatTranscript, maxTokensPerLine: 10);

        List<string> paragraphs = TextChunker.SplitPlainTextParagraphs(lines, 25);
    ...
    public TextChunkingAndEmbedding(ITestOutputHelper output) : base(output)
    {
    }
