...
namespace Resources.Plugins.DictionaryPlugin;
...
public sealed class ComplexParamsDictionaryPlugin
{
    ...
    public string GetWord([Description("Word to get definition for.")] DictionaryEntry entry)
    {
        ...
        return _dictionary.FirstOrDefault(e => e.Word == entry.Word)?.Word ?? "Entry not found";
    }
    ...
    {
        // Return the definition or a default message
        return _dictionary.FirstOrDefault(e => e.Word == word)?.Definition ?? "Word not found";
    }
}
