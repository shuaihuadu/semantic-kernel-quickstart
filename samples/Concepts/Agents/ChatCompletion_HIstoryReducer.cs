...
/// </summary>
[TestClass]
public class ChatCompletion_HistoryReducer : BaseTest
{
    private const string TranslatorName = "NumeroTranslator";
    private const string TranslatorInstructions = "Add one to latest user number and spell it in Chinese without explanation.";
